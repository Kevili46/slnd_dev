...
import { SkillCategoryComponent } from '#features/about/ui/skills/skill-category/skill-category.component.js';
import { CATEGORY, CategoryType } from '#features/about/models/category.model.js';
